"""Device receiver/transmitter models for WyreStorm NetworkHD 2 Integration."""
...
if TYPE_CHECKING:
    from wyrestorm_networkhd.models.api_query import DeviceJsonString, DeviceStatus, DeviceInfo
...
class DeviceBase:
    ...
    def get_device_display_name(self) -> str:
        ...
        return f"{self.device_type} - {self.alias_name or self.ip}"
...
def create_device_from_wyrestorm_models(
    ...
    # Create appropriate subclass based on device type
    if device_json.deviceType == "Receiver":
